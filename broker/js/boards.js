...
function insertItem(){
    ...
    var image = "<img src='images/tasks/board.png' width='32' height='32'/>";
    ...
    var btns = "<div class='btns'><a href='../index.html?keywords="+item.keywords+"&boardId="+item.id+"'>添加商品</a>&nbsp;<a href='boards-modify.html?id="+item.id+"'>编辑</a>&nbsp;<a href='../board2.html'>分享</a></div>";
