    ...
    $.ajax({
        ...
        success:function(ret){
            ...
            if($("#createNeedBtn").length==0){ 
                //添加新增need并注册事件
                $("#phaseNeedsDiv").append('<div class="sxTagNew" id="createNeedBtn" style="background-color:#514c49;border:1px solid #514c49;color:#fff;">+ 添加需要</div>');
                //注册点击事件：点击后弹出浮框完成修改或删除
