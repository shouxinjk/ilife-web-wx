...
function Sunburst(elementId, data, {
  ...
  const svg = d3.select(elementId).append("svg")//d3.create("svg")
  ...
  cell.append("path")
      ...
      .attr("fill", color ? d => color(d.ancestors().reverse()[1]?d.ancestors().reverse()[1].index:null) : fill)
